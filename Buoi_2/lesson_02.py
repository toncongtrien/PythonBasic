...
##For loop from 1 to infinity, therefore running forever.
import itertools
...
# Nhập vào 2 số nguyên a, b. In ra các số nguyên nằm trong khoảng giữa a và b trên cùng 1 dòng. Ví dụ: a = 5, b = 10 => 5,6,7,8,9,10
...
# Ví dụ: Nhập vào số tự nhiên n, tính tổng các số chia hết cho 3 mà nhỏ hơn n(0 3 6 9 12 Tổng các số nhỏ hơn 15 mà chia hết cho 3 là: 30)
n = int(input("Nhập n = "))
sum_three = 0
